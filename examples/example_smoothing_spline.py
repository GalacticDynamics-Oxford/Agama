...
data = numpy.hstack((numpy.random.normal(0, 1, 800), numpy.random.normal(2.0, 0.3, 200)))
...
# plot the results
x = numpy.linspace(-4.0, 4.0, 201)  # interval for plotting
...
grid = numpy.linspace(0.0, 11.0, 100)  # x-grid nodes for the spline (deliberately more than needed)
...
# plot the results
x = numpy.linspace(0.0, 11.0, 200)  # interval for plotting
