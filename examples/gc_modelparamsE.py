...
class ModelParams:
    ...
    def __init__(self, filename):
        ...
        self.maxValues = numpy.array([10.0, 2.0, 1.9, 6.0, 2.5, 1.0, 1.9, 6.0, 3.0, 0.5, 5.0])
        self.labels = (
        ...
        self.tracerBeta = lambda r: (self.trueParams[-2] + (r / 10 ** self.trueParams[-1]) ** 2) / (
            1 + (r / 10 ** self.trueParams[-1]) ** 2
        )
