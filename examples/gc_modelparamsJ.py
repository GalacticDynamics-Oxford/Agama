...
class ModelParams:
    ...
    def __init__(self, filename):
        ...
        """
        self.initValues = numpy.array([9.0, 0.1, 0.5, 4.0, 1.0, 6.0, 1.5, 1.0, 1.0, 1.0, 1.0])
        self.minValues = numpy.array([6.0, -1.0, -0.5, 2.2, 0.5, 3.2, 0.0, 0.5, 0.1, 0.1, -1.0])
        self.maxValues = numpy.array([10.0, 2.0, 1.9, 6.0, 2.5, 12.0, 2.8, 2.0, 2.8, 2.8, 3.0])
        self.labels = (
            r"$\log_{10}(\rho_\mathrm{scale})$",
            r"$\log_{10}(R_\mathrm{scale})$",
            r"$\gamma$",
            r"$\beta$",
            r"$\alpha$",
            r"$B_\mathrm{DF}$",
