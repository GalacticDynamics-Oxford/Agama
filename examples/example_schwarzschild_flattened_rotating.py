...
data, trajs = agama.orbit(
    potential=pot, ic=initcond, time=inttimes, dtype=object, targets=target, method="dprkn8", accuracy=1e-6
)  # use a more efficient orbit integrator and a lower (but still sufficient) accuracy
