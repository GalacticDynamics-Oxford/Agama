...
public:
    ...
    /// return the value of h corresponding to the given cumulative mass
...
/** Draw samples from a spherical isotropic distribution function f(h) provided by the model */
