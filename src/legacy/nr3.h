...
//#define _USESTDVECTOR_ 1   /* doesn't work! */
...
template<typename T> std::vector<T> vec(T x0, T x1) { std::vector<T> v(2); v[0]=x0; v[1]=x1; return v; }
template<typename T> std::vector<T> vec(T x0, T x1, T x2) { std::vector<T> v(3); v[0]=x0; v[1]=x1; v[2]=x2; return v; }
template<typename T> std::vector<T> vec(T x0, T x1, T x2, T x3) { std::vector<T> v(4); v[0]=x0; v[1]=x1; v[2]=x2; v[3]=x3; return v; }
template<typename T> std::vector<T> vec(T x0, T x1, T x2, T x3, T x4) { std::vector<T> v(5); v[0]=x0; v[1]=x1; v[2]=x2; v[3]=x3; v[4]=x4; return v; }
template<typename T> std::vector<T> vec(T x0, T x1, T x2, T x3, T x4, T x5) { std::vector<T> v(6); v[0]=x0; v[1]=x1; v[2]=x2; v[3]=x3; v[4]=x4; v[5]=x5; return v; }
