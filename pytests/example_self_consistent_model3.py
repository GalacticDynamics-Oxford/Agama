...
import agama, numpy, ConfigParser, os, sys, matplotlib.pyplot as plt
...
def printoutInfo(model, iteration):
    ...
    print \
        ...
        (densHalo.density(pt0), densHalo.density(pt2))
...
if __name__ == "__main__":
    ...
    numpy.savetxt("disk_plane",
        numpy.column_stack((R, Sigma, rho, rmsh, sigma[:,0]**0.5, (sigma[:,2]-vel[:,2]**2)**0.5, \
        sigma[:,1]**0.5, ToomreQ)),
        header="R Sigma rho(R,z=0) height sigma_R sigma_phi sigma_z ToomreQ", fmt="%.6g")
