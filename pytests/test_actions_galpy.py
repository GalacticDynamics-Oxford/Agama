...
g_actfinder = galpy.actionAngle.actionAngleStaeckel(pot=g_pot,delta=0.31,c=False)
#g_actfinder = galpy.actionAngle.actionAngleAdiabatic(pot=g_pot,c=True)
...
compare([0.5015, 0, 0, 1.164*0.5**.5, 1.164*0.5**.5, 0.2855],100.,1000)