...
\begin{subequations}
\begin{align}
h(E) &= \frac{16\pi^2}3 \int_0^{r_\mathrm{max}(E)} r^2\, v^3(E,r)\, dr = \int_{\Phi(0)}^E g(E')\, dE'  ,\\
g(E) &= 16\pi^2 \int_0^{r_\mathrm{max}(E)} r^2\, v(E,r)\, dr = 4\pi^2\, L_\mathrm{circ}^2(E)\, T_\mathrm{rad}(E) ,
\end{align}
\end{subequations}
