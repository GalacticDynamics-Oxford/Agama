...
int main() {
    ...
    particles::ParticleArrayCar
        diskParticles = particles::readSnapshot("../data/disk.dat", extUnits),
        haloParticles = particles::readSnapshot("../data/halo.dat", extUnits);
    ...
    try{
        ...
        haloPot = potential::readPotential("halo.coef_mul", extUnits);
        diskPot = potential::readPotential("disk.coef_cyl", extUnits);
    }
    catch(std::exception&) {
        ...
        writePotential("disk.coef_cyl", *diskPot, extUnits);
        writePotential("halo.coef_mul", *haloPot, extUnits);
    }
