...
int main() {
    ...
    try{
        ...
        diskPot = potential::readPotential("model_stars_final.coef_cyl", extUnits);
        haloPot = potential::readPotential("model_dm_final.coef_mul", extUnits);
    }
    catch(std::exception&) {
        ...
        writePotential("model_stars_final.coef_cyl", *diskPot, extUnits);
        writePotential("model_dm_final.coef_mul", *haloPot, extUnits);
    }
