...
\ttt{Spline} class providing one-dimensional cubic, quintic or B-spline interpolation, optionally computing up to two derivatives or an analytic convolution with a Gaussian kernel or another spline function;\\
